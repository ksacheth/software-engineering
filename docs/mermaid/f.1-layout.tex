...
\tikzset{
  ...
  datastore/.style={
    draw=entitystroke, line width=0.85pt, minimum width=5.2cm,
    minimum height=1.15cm, align=center, inner sep=2pt, font=\sffamily\small,
    path picture={
      \draw[entitystroke,line width=0.85pt]
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \draw[flow] (p12.south west) to[out=220,in=90]
    node[flowlabel,left,pos=0.42] {verification message} (smtp.north);
